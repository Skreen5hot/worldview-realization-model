...
Run: `credited_run_3c60bcdf3c`  |  credited: True
...
**Caveats that do not change the pre-registered classification but bound its meaning:**

* workflow-divergence magnitude does not discriminate: intended median divergence is at the 16.7th percentile of null `uniform` (companion statistic, not a pre-registered criterion)
* workflow-divergence magnitude does not discriminate: intended median divergence is at the 0.0th percentile of null `domain_structured` (companion statistic, not a pre-registered criterion)

Primary source: `source/WRM-Formal-Model-v0_2.md` (reconciliation in `source/WRM-v0_2-prototype-interpretation.md`; see `docs/assumptions.md` A-01).
...
```json
{
 ...
 "code_hash": "bafb1cfa694e2bc0e70e7f3887a6eaf05e19791bb888aa048e8bd69e291f1e28",
 "git_commit": "4e23a7a8da1c89396ff0e96ca7464bbf55a90789",
 ...
 "frozen_identity": "3c60bcdf3ccc2baa33b4bd39cc0ba7e962477b8db0ff556c304e93405d28f174"
}
```
...
Reference-library MRC audit (v0.2 §2.4; a standard counts in a domain when its patterns use a predicate of that domain):

| domain | #standards | standards |
|---|---|---|
| physical_causal | 11 | RC-01, RC-02, RC-04, RC-05, RC-07, RC-08, RC-09, RC-11, RC-12, RC-13, RC-14 |
| agentic | 3 | RC-07, RC-08, RC-12 |
| informational | 11 | RC-01, RC-03, RC-04, RC-06, RC-07, RC-08, RC-09, RC-10, RC-11, RC-12, RC-13 |
| evaluative_experiential | 2 | RC-09, RC-13 |
| legal_institutional | 4 | RC-01, RC-07, RC-08, RC-10 |
...
Lexical adjacency adj_Π (v0.2 §2.2, constructional statistic only):

|  | Dynamism | Materialism | Pneumatism | Rationalism |
|---|---|---|---|---|
| Dynamism | 1.0 | 0.3333 | 0.2 | 0.2308 |
| Materialism | 0.3333 | 1.0 | 0.125 | 0.3333 |
| Pneumatism | 0.2 | 0.125 | 1.0 | 0.125 |
| Rationalism | 0.2308 | 0.3333 | 0.125 | 1.0 |

Operational adjacency adj_op (activation similarity, witness similarity, polarity agreement on shared targeted edges):

| pair | activation sim. | witness sim. | shared targeted edges | polarity agreement | adj_op |
|---|---|---|---|---|---|
| Dynamism|Materialism | 0.1667 | 0.5652 | 4 | 1.0 | 0.5773 |
| Dynamism|Pneumatism | 0.0 | 0.037 | 0 | None | 0.0185 |
| Dynamism|Rationalism | 0.1111 | 0.0667 | 1 | 1.0 | 0.3926 |
| Materialism|Pneumatism | 0.1667 | 0.0909 | 0 | None | 0.1288 |
| Materialism|Rationalism | 0.0 | 0.0 | 0 | None | 0.0 |
| Pneumatism|Rationalism | 0.0 | 0.0 | 0 | None | 0.0 |

adj_op = mean of activation similarity, witness similarity and (where defined) polarity agreement on shared targeted edges. Prior estimate for the §5 non-adjacency requirement was not available; this is reported post hoc as a companion statistic.

Derived triage (v0.2 §7.5: w is prima facie relevant iff F_w(S) activates ≥1 standard with a live discrepancy):

| family | relevant | live references |
|---|---|---|
| Dynamism | True | RC-02, RC-11, RC-12, RC-13 |
| Materialism | True | RC-02, RC-05, RC-14 |
| Pneumatism | True | RC-08, RC-09 |
| Rationalism | True | RC-01, RC-03, RC-04, RC-06, RC-10, RC-11 |
...
| null | median workflow divergence: mean | p90 | intended median percentile | mean foreign full-pass fraction | frac all lineage pass |
|---|---|---|---|---|---|
| uniform | 0.6384 | 0.75 | 16.7 | 0.636 | 1.0 |
| domain_structured | 0.7486 | 0.75 | 0.0 | 0.458 | 1.0 |
...
D-1 criterion 2 (distinct value realization): satisfaction-condition sets per family — Materialism: RC-02, RC-05, RC-14; Rationalism: RC-01, RC-03, RC-04, RC-06, RC-10, RC-11; Dynamism: RC-02, RC-11, RC-12, RC-13; Pneumatism: RC-08, RC-09. Distinct sets: 4/4; disposition `VD-COURAGE` unchanged in all.
...
F1–F9 follow the task specification's list; V1–V7 follow the v0.2 §5 enumeration verbatim.

| id | falsifier | status | evidence |
|---|---|---|---|
...
| V1 | the p_w converge within the calibrated noise band (the dial does nothing) | NOT TESTABLE (deterministic generator: noise band is zero; divergence positive but uncalibrated) | 0.6616 |
| V2 | divergence appears but lineage or the blind-packet manifest fails | not triggered | all lineage audits pass; packets firewall-scanned and hashed |
| V3 | a dial setting yields no activatable standard on an MRC-certified scenario that contains that family's domain | not triggered | {'settings_without_activation': []} |
| V4 | the negative lineage control passes under foreign dials | not triggered | 0.0 |
| V5 | the placebo filter performs comparably | PARTIALLY TRIGGERED: comparable on workflow-divergence magnitude; not comparable on activation structure, coverage or foreign-dial selectivity | {'sds_percentile': {'uniform': 100.0, 'domain_structured': 100.0}, 'divergence_median_percentile': {'uniform': 16.7, 'domain_structured': 0. |
| V6 | ASSIGNMENT-FRAGILE at the frozen tolerance | not triggered | 0/7 perturbations fail Gate A criteria 1-4 |
| V7 | invariance breaks (d must be split to make outputs coherent) | not triggered | one disposition id across all workflows |
